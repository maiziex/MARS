...
def Print_haplotypes_for_linked_SNP_and_SV(in_dir,gnomad_dict,output_file,output_file_2,chr_num):
...
snp_dict_file = "/oak/stanford/groups/arend/Xin/AncestralProj/Results_MSA_MARS_hg38/MSA_SV_results_chr21/MSA_SV_files/SNP_dict.p"
snp_dict = pickle.load(open(snp_dict_file,"rb"))
#ref_dict_file = "/oak/stanford/groups/arend/Xin/AncestralProj/Results_MSA_MARS_hg38/ref_dir/ref_seq_chr21.p"
#ref_dict = pickle.load(open(ref_dict_file,"rb"))

gnomad_dict_file = "/oak/stanford/groups/arend/Xin/AncestralProj/gnomAD_hg38_snp/gnomad_snp_dict.p"
gnomad_dict = pickle.load(open(gnomad_dict_file,"rb"))

out_dir = "/oak/stanford/groups/arend/Xin/AncestralProj/Results_MSA_MARS_hg38/Final_tables/"
use_chr_num = 21
#Print_linked_SNPs_for_SV(out_dir,snp_dict,gnomad_dict,use_chr_num)


in_dir = "/oak/stanford/groups/arend/Xin/AncestralProj/Results_MSA_MARS_hg38/MSA_SV_results_chr21/MSA_SV_files/"
output_file = out_dir + "Haplotypes_by_Linked_SNP_and_SV_chr" + str(use_chr_num) + ".txt"
output_file_2 = out_dir + "Haplotypes_by_Linked_SNP_and_SV_chr" + str(use_chr_num) + "_counts.txt"
Print_haplotypes_for_linked_SNP_and_SV(in_dir,gnomad_dict,output_file,output_file_2,use_chr_num)
"""
