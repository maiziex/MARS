...
parser.add_argument('--out_dir','-o_dir', help="The folder name you can define to store the final results",default="./MARS_step1_results")
...
if len(sys.argv) == 1:
    Popen("python MARS_step1.py -h",shell=True).wait()
else:
